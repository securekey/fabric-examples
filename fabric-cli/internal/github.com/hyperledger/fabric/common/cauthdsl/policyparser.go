...
import (
	...
	fabcauthdsl "github.com/hyperledger/fabric-sdk-go/third_party/github.com/hyperledger/fabric/common/cauthdsl"
	"github.com/hyperledger/fabric-sdk-go/third_party/github.com/hyperledger/fabric/protos/common"
	"github.com/hyperledger/fabric-sdk-go/third_party/github.com/hyperledger/fabric/protos/msp"
	"github.com/securekey/fabric-examples/fabric-cli/internal/github.com/hyperledger/fabric/protos/utils"
)
...
func secondPass(args ...interface{}) (interface{}, error) {
	...
	for _, principal := range args[2:] {
		...
		case string:
			...
			dapolicy := fabcauthdsl.SignedBy(int32(ctx.IDNum))
	...
	return fabcauthdsl.NOutOf(int32(t), policies), nil
}
